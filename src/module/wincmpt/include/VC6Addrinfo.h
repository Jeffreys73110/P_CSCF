#ifndef _WINSOCK2_PATCH_
#define _WINSOCK2_PATCH_
#ifdef _MSC_VER
#if _MSC_VER<=1200
...
#define EAI_NOSECURENAME	11032
#define EAI_IPSECPOLICY		11033
...
#define gai_strerror			WspiapiGaiStrError
...
const char*
WINAPI
WspiapiGaiStrError(IN int ecode)
{
	if      (ecode==EAI_AGAIN)		 return "EAI_AGAIN";
	else if (ecode==EAI_BADFLAGS)	 return "EAI_BADFLAGS";
	else if (ecode==EAI_FAIL)		 return "EAI_FAIL";
	else if (ecode==EAI_FAMILY)		 return "EAI_FAMILY";
	else if (ecode==EAI_MEMORY)		 return "EAI_MEMORY";
	else if (ecode==EAI_NODATA)		 return "EAI_NODATA";
	else if (ecode==EAI_NONAME)		 return "EAI_NONAME";
	else if (ecode==EAI_SERVICE)	 return "EAI_SERVICE";
	else if (ecode==EAI_SOCKTYPE)	 return "EAI_SOCKTYPE";
	else if (ecode==EAI_NOSECURENAME)return "EAI_NOSECURENAME";
	else if (ecode==EAI_IPSECPOLICY) return "EAI_IPSECPOLICY";
	return "EAI_UKNOWN";
}
